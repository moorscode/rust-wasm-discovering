...
pub struct Game {
    drawables: Vec<Box<Line>>,
    // actors: Rc<RefCell<Vec<dyn Actor>>>,
}
...
impl Game {
    ...
    pub fn tick(&self, game_engine: &GameEngine) {
    ...
    pub fn handle_keypress(&self, game_engine: &GameEngine, key_code: u32) -> () {
        match key_code {
